...
public class WhereParser {
    ...
    private EQLParser sqlParser;

    public WhereParser(EQLParser sqlParser, SQLSelectQueryBlock query) {
        this.sqlParser = sqlParser;
        this.query = query;
        this.where = query.getWhere();
    }
//
//    public WhereParser(EQLParser sqlParser, SQLDeleteStatement delete) {
//        this.sqlParser = sqlParser;
//        this.delete = delete;
//        this.where = delete.getWhere();
//    }
//
//    public WhereParser(EQLParser sqlParser, SQLExpr expr) {
//        this.sqlParser = sqlParser;
//        this.where = expr;
//    }
//
//    public WhereParser(EQLParser sqlParser) {
//        this.sqlParser = sqlParser;
//    }
//
...
//        }
        if (expr instanceof SQLBinaryOpExpr) {
            ...
            Condition condition = new Condition(Where.CONN.valueOf("AND"), soExpr.getLeft().toString(), soExpr.getLeft(), soExpr.getOperator().name, parseValue(soExpr.getRight()), soExpr.getRight(), null);
