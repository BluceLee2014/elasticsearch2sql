 ...
 * @Desc
 * @date 2020/5/31 12:53
 * copy Created by Eliran on 18/8/2015.
 */
public class EQLExpression extends SQLExprParser {

    public EQLExpression(Lexer lexer) {
        super(lexer);
        this.aggregateFunctions = AGGREGATE_FUNCTIONS;
    }

    public EQLExpression(String sql) {
    ...
    public SQLSelectParser createSelectParser() {
        return new EQLSelectParser(this);
    }
