 ...
 */
public class EQLSelectParser extends SQLSelectParser {
    public EQLSelectParser(SQLExprParser exprParser) {
        super(exprParser);
    }

    public EQLSelectParser(String sql) {
        this(new EQLExpressionParser(sql));
    }
    ...
    public MySqlSelectQueryBlock.Limit parseLimit() {
        return ((EQLExpressionParser) this.exprParser).parseLimit();
    }

    public EQLExpressionParser getExprParser() {
        return (EQLExpressionParser) exprParser;
    }
}
